...
> = FieldName<
  ...
  Option2
>;
type WithClz<D extends FieldDescriptorLites> = D extends WithClzField
  ? { _clz: _Clz<D> }
  : // eslint-disable-next-line @typescript-eslint/no-explicit-any
    { _clz?: any };
type _ToType<D extends FieldDescriptorLites> = {
...
export type ToType<D extends FieldDescriptorLites> = _ToType<
